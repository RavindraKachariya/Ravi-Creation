        ...
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all duration-300 z-50 ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600 h-full w-full px-5'>
                    ...
                    <NavLink onClick={() => setVisible(false)} to='/' className='flex flex-col items-center gap-1 py-5 border-t'>HOME</NavLink>
                    <NavLink onClick={() => setVisible(false)} to='/collection' className='flex flex-col items-center gap-1 py-5 border-t'>COLLECTION</NavLink>
                    <NavLink onClick={() => setVisible(false)} to='/about' className='flex flex-col items-center gap-1 py-5 border-t'>ABOUT</NavLink>
                    <NavLink onClick={() => setVisible(false)} to='/contact' className='flex flex-col items-center gap-1 py-5 border-t'>CONTACT</NavLink>
                </div>
            </div>
