...
const EditProduct = () => {
    ...
    const [form, setForm] = useState({
        name: 'Wooden Car Hanger - Black',
        description: 'Premium quality wooden car hanger with a matte black finish. Fits most car models.',
        material: 'Wood',
        finish: 'Matte Black',
        price: '1200',
        stock: '45',
    ...
    return (
        <div className="space-y-6 max-w-3xl">
            <div className="flex items-center gap-3">
                <button onClick={() => navigate('/products')} className="p-1.5 rounded-lg hover:bg-gray-100 transition text-gray-400">
                    <ChevronLeft size={18} />
                </button>
                <div>
                    <h1 className="text-xl font-semibold text-gray-900">Edit Product</h1>
                    <p className="text-xs text-gray-400 mt-0.5">Product ID: #{id}</p>
                </div>
            </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:border-black transition"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:border-black transition resize-none"
                        />
                    </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-5">
                    ...
                    <div className="flex gap-4">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="bestseller" checked={form.bestseller} onChange={handleChange} className="accent-black" />
                            <span className="text-sm text-gray-600">Bestseller</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="newArrival" checked={form.newArrival} onChange={handleChange} className="accent-black" />
